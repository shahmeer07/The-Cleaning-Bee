...
const FAQsScreen = () => {
  return (
    <SafeAreaView style={{ backgroundColor: "#FDD835" }}>
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.questionContainer}>
            ...
            <Text style={styles.answer}>
              ...
              desired package screen (Cleaning Packages, Laundry Packages, or
              Dry Cleaning Packages), browse through the available options, and
              select the package you want. Then, follow the prompts to provide
              any necessary details and complete the checkout process.
            </Text>
          </View>

          <View style={styles.questionContainer}>
            <Text style={styles.question}>
              Q: Can I schedule the cleaning service for a specific date and
              time?
            </Text>
            <Text style={styles.answer}>
              ...
              Our team will make arrangements to ensure the cleaning service is
          ...
          <View style={styles.questionContainer}>
            ...
            <Text style={styles.answer}>
              ...
              and more. You can find detailed information about the specific
              tasks included in each package on the respective package screen.
            </Text>
          </View>
          ...
          <View style={styles.questionContainer}>
            ...
            <Text style={styles.answer}>
              ...
              such as the size of your home or space and the specific package
              you choose. Typically, our cleaning services range from 1 to 4
              hours. However, for larger or more extensive cleaning projects,
              the duration may be longer. Rest assured, our team works
              efficiently to ensure a thorough and timely cleaning experience.
            </Text>
          </View>
          ...
          <View style={styles.questionContainer}>
            ...
            <Text style={styles.answer}>
              ...
              complete the booking process, our team will assign a dedicated
              maid for your specified duration.
            </Text>
          </View>
          ...
          <View style={styles.questionContainer}>
            ...
            <Text style={styles.answer}>
              ...
              items you need and specify the quantity for each item. This way,
              you can tailor your order to include the exact cleaning supplies
              you require.
            </Text>
          </View>
          ...
          <View style={styles.questionContainer}>
            ...
            <Text style={styles.answer}>
              A: We strive to process and deliver your cleaning supplies order
              as quickly as possible. The estimated delivery time depends on
              various factors such as your location and the shipping method
              chosen. Typically, you can expect to receive your order within 2-7
